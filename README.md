...
|---------------------------------------------------------------------|------------------------------|-----------------------------------------------------------------------------------------------------------------------------|----------------------------------------|
| [ONTAP MCP Server](https://netapp.github.io/ontap-mcp/nightly/) | Remote (http) | Administer your [ONTAP](https://www.netapp.com/ontap-data-management-software/) clusters/instances - supports multi-cluster management, volume lifecycle operations, data protection policies, and NFS/CIFS access control. | <ul><li>NetApp AFX</li> <li>NetApp AFF</li> <li>NetApp FAS</li> <li>Amazon FSx for NetApp ONTAP</li> <li>NetApp Cloud Volumes ONTAP</li> <li>NetApp ONTAP Select</li></ul> |
| [Harvest MCP Server](https://netapp.github.io/harvest/nightly/mcp/overview/) | Local (stdio) and remote (http) options | Query your [Harvest](https://netapp.github.io/harvest)-collected ONTAP, StorageGRID, and Cisco metrics. | <ul><li>Harvest</li></ul> |
| [AI Data Engine (AIDE) MCP Server](https://github.com/NetApp/aide-mcp-server) | Local (stdio) | Search for documents using [AIDE](https://docs.netapp.com/us-en/ai-data-engine/index.html)'s RAG/vector search API. | <ul><li>NetApp AI Data Engine (AIDE)</li></ul> |
